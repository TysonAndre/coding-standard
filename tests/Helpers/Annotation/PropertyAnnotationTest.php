...
class PropertyAnnotationTest extends TestCase
{
	...
	{
		$annotation = new PropertyAnnotation('@property', 1, 10, null, 'Description', new PropertyTagValueNode(new IdentifierTypeNode('string'), '$property', 'Description'));
	...
	public function testUnsupportedAnnotation(): void
	{
		...
		new PropertyAnnotation('@var', 1, 1, null, null, null);
	}
	...
	public function testGetDescriptionWhenInvalid(): void
	{
		...
		$annotation = new PropertyAnnotation('@property', 1, 1, null, null, null);
	...
	public function testGetPropertyNameWhenInvalid(): void
	{
		...
		$annotation = new PropertyAnnotation('@property-read', 1, 1, null, null, null);
	...
	public function testGetTypeWhenInvalid(): void
	{
		...
		$annotation = new PropertyAnnotation('@property-write', 1, 1, null, null, null);
		$annotation->getType();
	}
