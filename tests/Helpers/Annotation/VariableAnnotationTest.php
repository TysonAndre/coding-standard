...
class VariableAnnotationTest extends TestCase
{
	...
	{
		$annotation = new VariableAnnotation('@var', 1, 10, null, 'Description', new VarTagValueNode(new IdentifierTypeNode('string'), '', 'Description'));
	...
	public function testUnsupportedAnnotation(): void
	{
		...
		new VariableAnnotation('@param', 1, 1, null, null, null);
	}
	...
	public function testGetDescriptionWhenInvalid(): void
	{
		...
		$annotation = new VariableAnnotation('@var', 1, 1, null, null, null);
